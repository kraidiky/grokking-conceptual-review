...
[sparse-solutions-hidden-progress](sparse-solutions-hidden-progress.md) ← предыдущая карточка, следующая → [polysemanticity-superposition](polysemanticity-superposition.md)
