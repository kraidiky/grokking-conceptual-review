...
Форму кривых, по которой зона опознаётся, работа Omnigrok называет **LU-механизмом** (LU mechanism): обучающая и тестовая потери расходятся по буквам L и U при изменении нормы весов.
