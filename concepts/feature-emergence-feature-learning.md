...
**\[4.4\]** 2411.05353 — Salah et al., «Controlling Grokking with Nonlinearity and Data Symmetry». `"accompanied by the emergence of structure in the embeddings"` (line 80). *«сопровождается возникновением структуры в эмбеддингах»*
...
**\[4.6\]** 2510.25966 — Hutchison et al., «Grokking in the Ising Model». `"sequentially identify global features of the input classes, which enables generalization to previously unseen patterns"` (line 18). *«последовательно выделяют глобальные признаки входных классов, что обеспечивает генерализацию на ранее не встречавшиеся образцы»*
