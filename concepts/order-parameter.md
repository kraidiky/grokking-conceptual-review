...
[Каузальная абляция](causal-ablation-intervention.md) ← предыдущая карточка, следующая → [Тяжёлохвостовая саморегуляризация](heavy-tailed-self-regularization-htsr.md)
