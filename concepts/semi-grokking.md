...
![Полу-грокинг вблизи критического размера данных: точность, потеря и норма параметров одного запуска — генерализация останавливается на частичном уровне (рис. 6 Varma et al.)](assets/semi-grokking-run.png)
