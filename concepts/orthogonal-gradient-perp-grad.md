...
[Частотный принцип / спектральное смещение](frequency-principle-spectral-bias.md) ← предыдущая карточка, следующая → [model-complexity-error-tradeoff](model-complexity-error-tradeoff.md)
