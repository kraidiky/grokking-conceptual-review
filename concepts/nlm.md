...
![Траектории модели над ландшафтом потерь: без вмешательств оптимизация уходит в направление наивной минимизации потерь — рост логитов без изменения предсказаний (рис. 7 Prieto et al.)](assets/nlm-trajectories.png)
