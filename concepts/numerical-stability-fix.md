...
###### ref-3-3
**\[3.3\]** 2607.05104 — Ootani 2026, «Grokking Is Conditional and Fragile: A Fully-Tractable, Multi-Seed Study at 12K Parameters». Числовое лезвие нового рода, отличное от Softmax Collapse: смена числа потоков CPU — чистая перестановка порядка суммирования при неассоциативном сложении с плавающей точкой (4 и 16 потоков дают побитово тождественные веса, чистое возмущение — 1 против 4) — переворачивает grok-исход у 49 из 300 парных семян (средний сдвиг лучшей точности 0.17, максимум 0.85), а CPU против GPU при отключённом TF32 — у 19 из 100; оба возмущения не сдвигают совокупную долю (McNemar $p=0.39$/$1.0$, интервалы Ньюкомба в пределах $\pm 10$ пунктов). У Prieto et al. числовой отказ систематически подавляет гроккинг; здесь возмущение переставляет, какие семена обобщают, не меняя сколько. Нюанс: прочтение «котловина настолько мелка, что суб-ULP различия решают вход» объявлено прочтением, не измерением; доля переворотов подпёрта порогом 0.70, и в 16% неотделимы семена, стоявшие у порога; обстановка узка — Intel MKL на AMD Zen 2 и один RTX 3090 Ti. [`"The perturbation flips *which* seeds generalize, not *how many*."`](../papers/2607.05104.grokking-is-conditional-and-fragile-a-fully-tractable-multi-seed-study-at-12k-parameters/original/2607.05104.grokking-is-conditional-and-fragile-a-fully-tractable-multi-seed-study-at-12k-parameters.md#p8-1). *«[Возмущение переворачивает, *какие* семена генерализуют, не *сколько*.](../papers/2607.05104.grokking-is-conditional-and-fragile-a-fully-tractable-multi-seed-study-at-12k-parameters/2607.05104.grokking-is-conditional-and-fragile-a-fully-tractable-multi-seed-study-at-12k-parameters.card.md#p8-1)»*
