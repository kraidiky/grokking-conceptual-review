...
###### ref-3-4
**\[3.4\]** 2604.07380 — Xu 2026, «The Lifecycle of the Spectral Edge: From Gradient Learning to Weight-Decay Compression». Показательный разрыв зондов: линейный зонд глубины падает до 0.86 (у отдельных семян до 0.67), квадратичный — до 0.59, а MLP-зонд держит 0.990 — сведения не теряются, а нелинейно перекодируются weight-decay-сжатием; у запомнившей модели линейный зондовый показатель выше, что истолковано как признак явного хранения, а не лучшего вычисления. [`"A shallow MLP probe (one hidden layer, 64 units) recovers $R^{2}=0.990\pm 0.003$ on the same representations"`](../papers/2604.07380.the-lifecycle-of-the-spectral-edge-from-gradient-learning-to-weight-decay-compression/original/2604.07380.the-lifecycle-of-the-spectral-edge-from-gradient-learning-to-weight-decay-compression.md#p5-5). *«[Неглубокий MLP-зонд (один скрытый слой, 64 узла) возвращает $R^{2}=0.990\pm 0.003$ на тех же представлениях](../papers/2604.07380.the-lifecycle-of-the-spectral-edge-from-gradient-learning-to-weight-decay-compression/2604.07380.the-lifecycle-of-the-spectral-edge-from-gradient-learning-to-weight-decay-compression.card.md#p5-5)»*\
Доп. (инверсия): [`"the memorized model has *higher* linear probe $R^{2}$ for depth (0.95 vs. 0.71)"`](../papers/2604.07380.the-lifecycle-of-the-spectral-edge-from-gradient-learning-to-weight-decay-compression/original/2604.07380.the-lifecycle-of-the-spectral-edge-from-gradient-learning-to-weight-decay-compression.md#p10-1) — *«[у запомнившей модели *выше* линейный зондовый $R^{2}$ глубины (0.95 против 0.71)](../papers/2604.07380.the-lifecycle-of-the-spectral-edge-from-gradient-learning-to-weight-decay-compression/2604.07380.the-lifecycle-of-the-spectral-edge-from-gradient-learning-to-weight-decay-compression.card.md#p10-1)»*.

###### ref-3-5
**\[3.5\]** 2606.00230 — Muckatira, Shivagunde, Deshpande, Rumshisky 2026, «A Pre-Training Analogue of Grokking in Language Models: Tracing Delayed Grammatical Generalization». Грамматический концепт-вектор как разность скрытых состояний приемлемого и неприемлемого предложений минимальной пары BLiMP: средний вектор, посчитанный на proxy-train, разделяет грамматичность на proxy-validation скалярным произведением (AUROC), а действенный ранг центрированной матрицы концепт-векторов после перехода выше, чем до, во всех пяти наборах — вопреки линии «после генерализации представления сжимаются». Нюанс: AUROC отчётливо растёт лишь у трёх явлений из пяти (у неправильных причастий отделимость высока с начала, у второго согласования — у случайного уровня); спор о сжатии ведётся на несопоставимых мерах — ранг считается по разностям пар, а цитируемые работы мерили сами скрытые состояния; сравнение точек $t_{\text{before}}=100$ и $t_{\text{after}}$ (500–1400 шагов) спутано с общим ходом раннего обучения. [`"we find that for these concept vectors, effective rank generally increases after delayed generalization, suggesting that the grammatical concept does not collapse into a few dominant directions."`](../papers/2606.00230.a-pre-training-analogue-of-grokking-in-language-models-tracing-delayed-grammatical-generalization/original/2606.00230.a-pre-training-analogue-of-grokking-in-language-models-tracing-delayed-grammatical-generalization.md#p7-2). *«[мы находим, что для этих концепт-векторов действенный ранг в целом растёт после отсроченной генерализации, подсказывая, что грамматическое понятие не схлопывается в несколько доминирующих направлений.](../papers/2606.00230.a-pre-training-analogue-of-grokking-in-language-models-tracing-delayed-grammatical-generalization/2606.00230.a-pre-training-analogue-of-grokking-in-language-models-tracing-delayed-grammatical-generalization.card.md#p7-2)»*
