...
###### ref-3-4
**\[3.4\]** 2606.18465 — Truong 2026, «What Does the Weight Norm Control in Grokking? Logit-Scale Mediation under Cross-Entropy». Канал SC поставлен опосредователем нормо-наведённой задержки: температурный тест изолирует его верховье (действенный масштаб логитов) при физически зажатой норме, а float64-аудит достигает той же точки без вмешательства — при $\rho=1.15$ закон устойчив к точности (частота коллапса нулевая в обеих точностях), при $\rho=1.25$ float32-коллапс с частотой $0.31$ ускоряет ложный переход, которого в float64 нет к 60k шагов. Нюанс: знак действия обратен исходному счёту — здесь насыщение софтмакса дозированно удлиняет задержку, а коллапс лишь его обрывная крайность. [`"softmax collapse is the extreme of the same logit-saturation channel that the temperature test isolates, reached by precision without any intervention"`](../papers/2606.18465.what-does-the-weight-norm-control-in-grokking-logit-scale-mediation-under-cross-entropy/2606.18465.what-does-the-weight-norm-control-in-grokking-logit-scale-mediation-under-cross-entropy.card.md#p9-1). *«[коллапс софтмакса — крайность того же канала насыщения логитов, который выделяет температурный тест, достигнутая точностью вычислений без всякого вмешательства](../papers/2606.18465.what-does-the-weight-norm-control-in-grokking-logit-scale-mediation-under-cross-entropy/2606.18465.what-does-the-weight-norm-control-in-grokking-logit-scale-mediation-under-cross-entropy.card.md#p9-1)»*\
Доп. (верховье канала): [`"Our temperature test isolates the upstream of that channel, the logit scale, and shows it mediates most of the norm-induced delay under cross-entropy"`](../papers/2606.18465.what-does-the-weight-norm-control-in-grokking-logit-scale-mediation-under-cross-entropy/2606.18465.what-does-the-weight-norm-control-in-grokking-logit-scale-mediation-under-cross-entropy.card.md#p9-3). *«[Наш температурный тест выделяет верховье этого канала, масштаб логитов, и показывает, что он опосредует большую часть наведённой нормой задержки под кросс-энтропией](../papers/2606.18465.what-does-the-weight-norm-control-in-grokking-logit-scale-mediation-under-cross-entropy/2606.18465.what-does-the-weight-norm-control-in-grokking-logit-scale-mediation-under-cross-entropy.card.md#p9-3)»*

###### ref-3-5
**\[3.5\]** 2606.32000 — Tiwari, Chauhan & Singh 2026, «Radial Suppression Accelerates Algorithmic Generalization: A Geometric Analysis of Delayed Generalization». Механизм насыщения взят источником «радиального раздувания» активаций, а вмешательство Prieto перенесено из пространства параметров в пространство активаций: вместо проекции градиента $\perp$Grad — мягкий штраф на норму скрытого представления, встроенный в потерю. Нюанс: сам радиус $\|h(t)\|_{2}$ — центральная величина механизма — в статье нигде не показан; о раздувании судят по доле радиальной энергии градиента $\tilde{\Phi}_{\mathrm{rad}}$ и косвенным следствиям. [`"standard cross-entropy incentivizes outward growth of hidden activations to push logits into the saturating regime of softmax"`](../papers/2606.32000.radial-suppression-accelerates-algorithmic-generalization-a-geometric-analysis-of-delayed-generalization/2606.32000.radial-suppression-accelerates-algorithmic-generalization-a-geometric-analysis-of-delayed-generalization.card.md#p1-6). *«[стандартная кросс-энтропия поощряет рост скрытых активаций наружу, чтобы затолкнуть логиты в насыщающую область софтмакса](../papers/2606.32000.radial-suppression-accelerates-algorithmic-generalization-a-geometric-analysis-of-delayed-generalization/2606.32000.radial-suppression-accelerates-algorithmic-generalization-a-geometric-analysis-of-delayed-generalization.card.md#p1-6)»*\
Доп. (что именно перенесено): [`"their $\perp$Grad projects gradients away from magnitude-scaling directions in *parameter* space"`](../papers/2606.32000.radial-suppression-accelerates-algorithmic-generalization-a-geometric-analysis-of-delayed-generalization/2606.32000.radial-suppression-accelerates-algorithmic-generalization-a-geometric-analysis-of-delayed-generalization.card.md#p2-6). *«[их $\perp$Grad проецирует градиенты прочь от направлений масштабирования величины в пространстве *параметров*](../papers/2606.32000.radial-suppression-accelerates-algorithmic-generalization-a-geometric-analysis-of-delayed-generalization/2606.32000.radial-suppression-accelerates-algorithmic-generalization-a-geometric-analysis-of-delayed-generalization.card.md#p2-6)»*
## Цитирования
